...
import com.example.baisibudejie.projects.essence.adapter.EssenceAdapter;
import com.example.baisibudejie.projects.essence.view.navigation.EssenceNavigationBuilder;
...
public class EssenceFragment extends BaseFragment {
    ...
    private void initToolBar(View viewContent) {
        ...
        builder.setTitleIcon(R.drawable.main_essence_title)
                .setTitleLeftIcon(R.drawable.main_essence_btn_selector)
                .setTitleRightIcon(R.drawable.main_essence_btn_more_selector)
